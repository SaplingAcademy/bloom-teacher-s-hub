...
> **Directory layout** (top-level folders) follows the project's scaffolding skill — do not invent a competing structure here. This skill is about _which layer code belongs to_, not where the folders sit.
